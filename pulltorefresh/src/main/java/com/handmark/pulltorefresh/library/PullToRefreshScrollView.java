...
public class PullToRefreshScrollView extends PullToRefreshBase<ScrollView> {
	...
	private PullToRefreshScrollView.IScrollChangeListener mScrollChangeListener;


	public void setScrollChangeListener(PullToRefreshScrollView.IScrollChangeListener listener) {
		mScrollChangeListener = listener;
	}

	public static interface IScrollChangeListener {
