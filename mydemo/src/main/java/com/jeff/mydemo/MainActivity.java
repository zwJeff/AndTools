...
import com.jeff.bannercircleview.BannerCirlePlayer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play = (BannerCirlePlayer) findViewById(R.id.bannercircle);
        ...
        play.setData(urlList,lis,true,2*1000);
